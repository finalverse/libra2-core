...
///
/// This module allows users to "register" a veiled account for any pre-existing `libra2_framework::Coin` type `T` via
...
/// ```
///
/// Recall that: A coin has a *decimal precision* $d$ (e.g., for `Libra2Coin`, $d = 8$; see `initialize` in
/// `libra2_coin.move`). This precision $d$ is used when displaying a `u64` amount, by dividing the amount by $10^d$.
...
module veiled_coin::veiled_coin {
    ...
    /// represent normal `libra2_framework::coin::Coin` values.
