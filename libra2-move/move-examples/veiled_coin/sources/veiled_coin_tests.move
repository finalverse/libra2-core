...
module veiled_coin::veiled_coin_tests {
    ...
    fun set_up_for_veiled_coin_test(
        ...
        println(b"Created fake money inside @libra2_framework");
    ...
    #[test(veiled_coin = @veiled_coin, aptos_fx = @libra2_framework, sender = @0xc0ffee, recipient = @0x1337)]
    fun veil_test(
        veiled_coin: signer,
        aptos_fx: signer,
        sender: signer,
    ...
    #[test(veiled_coin = @veiled_coin, aptos_fx = @libra2_framework, sender = @0x1337)]
    fun unveil_test(
        veiled_coin: signer,
        aptos_fx: signer,
        sender: signer,
