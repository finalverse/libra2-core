script {
    ...
    fun main(attacker: &signer) {
        ...
        //    |- /tmp/aptos-core/libra2-move/move-examples/raffle/scripts/test_and_abort_attack_defeated.move:19:9
        //    |
        ...
        //    |
        //    |- /tmp/aptos-core/libra2-move/move-examples/raffle/sources/raffle.move:122:15
        //    |
