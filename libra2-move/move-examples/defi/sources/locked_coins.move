...
module defi::locked_coins {
    ...
    #[test_only]
    use libra2_framework::coin::BurnCapability;
    #[test_only]
    ...
    #[test_only]
    fun setup(libra2_framework: &signer, sponsor: &signer): BurnCapability<AptosCoin> {
    ...
    #[test(libra2_framework = @0x1, sponsor = @0x123, recipient = @0x234)]
    public entry fun test_recipient_can_claim_coins(
        libra2_framework: &signer, sponsor: &signer, recipient: &signer) acquires Locks {
        let burn_cap = setup(libra2_framework, sponsor);
    ...
    #[test(libra2_framework = @0x1, sponsor = @0x123, recipient_1 = @0x234, recipient_2 = @0x345)]
    public entry fun test_sponsor_can_batch_update_lockup(
        libra2_framework: &signer, sponsor: &signer, recipient_1: &signer, recipient_2: &signer) acquires Locks {
        let burn_cap = setup(libra2_framework, sponsor);
    ...
    #[test(libra2_framework = @0x1, sponsor = @0x123, recipient = @0x234, withdrawal = @0x345)]
    public entry fun test_sponsor_can_cancel_lockup(
        libra2_framework: &signer, sponsor: &signer, recipient: &signer, withdrawal: &signer) acquires Locks {
        let burn_cap = setup(libra2_framework, sponsor);
        let recipient_addr = signer::address_of(recipient);
    ...
    #[test(libra2_framework = @0x1, sponsor = @0x123, recipient_1 = @0x234, recipient_2 = @0x345, withdrawal = @0x456)]
    ...
    #[test(libra2_framework = @0x1, sponsor = @0x123, recipient = @0x234, withdrawal = @0x456)]
