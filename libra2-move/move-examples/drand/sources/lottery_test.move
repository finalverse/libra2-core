module drand::lottery_test {
    ...
    #[test_only]
    use libra2_framework::coin::MintCapability;
    #[test_only]
    use std::vector;
    #[test_only]
    use std::string;
    ...
    #[test(myself = @drand, fx = @libra2_framework, u1 = @0xA001, u2 = @0xA002, u3 = @0xA003, u4 = @0xA004)]
    fun test_lottery(
        ...
        while(!vector::is_empty(&vec_signed_bytes)) {
            ...
            // Create fake coins for users participating in lottery & initialize libra2_framework
