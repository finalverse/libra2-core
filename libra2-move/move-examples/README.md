...
1. Clone this repo by running `git clone https://github.com/finalverse/libra2-core.git`
...
4. You can use the Aptos CLI to compile, test, publish, and run these contracts by using the commands outlined here: https://dev.libra2.org/move/move-on-aptos/cli/
     - If you need to install the Aptos CLI, you can follow these instructions: https://dev.libra2.org/tools/aptos-cli/install-cli/
