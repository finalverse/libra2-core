...
module shared_account::SharedAccount {
    ...
    public fun set_up(user: signer, test_user1: signer, test_user2: signer) : address acquires SharedAccountEvent {
        ...
        libra2_framework::aptos_account::create_account(user_addr1);
        libra2_framework::aptos_account::create_account(user_addr2);
    ...
    #[test(user = @0x1111, test_user1 = @0x1112, test_user2 = @0x1113, core_framework = @libra2_framework)]
