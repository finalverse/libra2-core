...
fn test_metadata_tracking() {
    ...
    let coin_store = parse_struct_tag("0x1::coin::CoinStore<0x1::libra2_coin::Libra2Coin>").unwrap();
    ...
    harness.run_transaction_payload(
        &account1,
        libra2_cached_packages::libra2_stdlib::libra2_account_transfer(address2, 100),
    );
    ...
    harness.run_transaction_payload(
        &account1,
        libra2_cached_packages::libra2_stdlib::libra2_account_transfer(address3, 100),
    );
