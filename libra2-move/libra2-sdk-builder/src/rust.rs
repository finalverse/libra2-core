...
struct RustEmitter<T> {
    ...
    /// Whether we are targeting the Libra2 repository itself (as opposed to generated Libra2 types).
    local_types: bool,
}
...
pub fn decode(payload: &TransactionPayload) -> Option<EntryFunctionCall> {{
    ...
    fn output_transaction_script_name_method(
        ...
        writeln!(
            self.out,
            r#"
/// Return the name of an Libra2 `Script` from a structured object `ScriptCall`.
