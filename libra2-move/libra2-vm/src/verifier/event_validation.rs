...
use libra2_framework::RuntimeModuleMetadataV1;
...
pub(crate) fn validate_module_events(
    ...
    for module in modules {
        let mut new_event_structs =
            if let Some(metadata) = libra2_framework::get_metadata_from_compiled_module(module) {
...
pub(crate) fn extract_event_metadata_from_module(
    ...
    if module_storage.is_enabled() {
        ...
        let metadata = module_storage
            ...
            .map(|module| libra2_framework::get_metadata_from_compiled_module(module.as_ref()));
        ...
        let metadata = session
            ...
            .map(|module| {
                ...
                .map(|module| libra2_framework::get_metadata_from_compiled_module(&module))
            });
