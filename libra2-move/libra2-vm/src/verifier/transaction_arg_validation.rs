...
use crate::{libra2_vm::SerializedSigners, move_vm_ext::SessionExt, VMStatus};
...
pub(crate) fn validate_combine_signer_and_txn_args(
    ...
    let _timer = VM_TIMER.timer_with_label("Libra2VM::validate_combine_signer_and_txn_args");
