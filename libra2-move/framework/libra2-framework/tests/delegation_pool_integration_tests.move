#[test_only]
module libra2_framework::delegation_pool_integration_tests {
    use std::features;
    use std::signer;
    ...
    use libra2_framework::delegation_pool as dp;
    ...
    public fun initialize_for_test_custom(
        ...
        reconfiguration::initialize_for_test(libra2_framework);
        features::change_feature_flags_for_testing(libra2_framework, vector[DELEGATION_POOLS, MODULE_EVENT], vector[]);
    }
    ...
    #[expected_failure(abort_code = 0x10007, location = libra2_framework::stake)]
    ...
    public entry fun test_end_to_end(
        ...
        assert!(coin::balance<Libra2Coin>(validator_address) == 800 * ONE_APT, 2);
        ...
        assert!(coin::balance<Libra2Coin>(validator_address) == 84999999999, 6);
        stake::assert_validator_state(pool_address, 10201000001, 5099999999, 0, 0, 0);
        dp::withdraw(validator, pool_address, 51 * ONE_APT);
        assert!(coin::balance<Libra2Coin>(validator_address) == 90099999998, 7);
    ...
    #[test(libra2_framework = @libra2_framework, validator_1 = @0x123, validator_2 = @0x234)]
    #[expected_failure(abort_code = 0x1000D, location = libra2_framework::stake)]
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x10006, location = libra2_framework::delegation_pool)]
    ...
    public entry fun test_active_validator_withdraw_should_cap_by_inactive_stake(
        ...
        assert!(coin::balance<Libra2Coin>(signer::address_of(validator)) == 100100000000, 2);
    ...
    public entry fun test_delegated_staking_with_owner_cap(
        ...
        assert!(coin::balance<Libra2Coin>(signer::address_of(validator)) == 101 * ONE_APT, 1);
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = libra2_framework::stake)]
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000E, location = libra2_framework::stake)]
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000B, location = libra2_framework::stake)]
    ...
    public entry fun test_removing_validator_from_active_set(
        ...
        stake::remove_validators(libra2_framework, &vector[validator_to_remove]);
