 ...
 */
module libra2_framework::delegation_pool {
    use std::error;
    use std::features;
    use std::signer;
    use std::vector;
    ...
    use libra2_framework::stake::get_operator;
    use libra2_framework::staking_config;
    use libra2_framework::timestamp;

    const MODULE_SALT: vector<u8> = b"libra2_framework::delegation_pool";
    ...
    #[test_only]
    use libra2_framework::timestamp::fast_forward_seconds;
    ...
    #[test_only]
    public fun enable_delegation_pool_allowlisting_feature(libra2_framework: &signer) {
        features::change_feature_flags_for_testing(
            libra2_framework,
    ...
    public entry fun test_delegation_pools_disabled(
        ...
        features::change_feature_flags_for_testing(libra2_framework, vector[], vector[DELEGATION_POOLS]);
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123, delegator = @0x010)]
    ...
    #[test(libra2_framework = @libra2_framework, old_operator = @0x123, delegator = @0x010, new_operator = @0x020)]
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123, delegator1 = @0x010, voter1 = @0x030)]
    ...
    public entry fun test_voting_power_change_already_voted_before_partial(
        ...
        let proposal1_id = setup_vote(libra2_framework, validator, false);
    ...
    public entry fun test_vote_should_failed_if_no_stake(
        ...
        // partial voing hasn't been enabled yet. A proposal has been created by the validator.
        let proposal1_id = setup_vote(libra2_framework, validator, true);
    ...
    public entry fun test_vote_should_failed_due_to_insufficient_stake_lockup (
        ...
        let _ = setup_vote(libra2_framework, validator1, false);
    ...
    public entry fun test_delegate_voting_power_should_pass_even_if_no_stake(
        ...
        // partial voing hasn't been enabled yet. A proposal has been created by the validator.
        setup_vote(libra2_framework, validator, true);
    ...
    #[test(libra2_framework = @libra2_framework, validator = @0x123, delegator_1 = @0x010, delegator_2 = @0x020)]
