spec libra2_framework::create_signer {
    use std::signer;

    /// <high-level-req>
    /// No.: 1
    /// Requirement: Obtaining a signer for an arbitrary account should only be available within the Libra2 Framework.
    ...
    /// Enforcement: Enforced by the [https://github.com/finalverse/libra2-core/blob/main/third_party/move/move-vm/types/src/values/values_impl.rs#L1129](move vm).
    ///
    /// No.: 3
