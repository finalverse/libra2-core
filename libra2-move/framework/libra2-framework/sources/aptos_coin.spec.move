spec libra2_framework::aptos_coin {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced through the [https://github.com/aptos-labs/aptos-core/blob/main/libra2-move/framework/libra2-framework/sources/coin.move](coin)
    ...
    spec initialize(libra2_framework: &signer): (BurnCapability<AptosCoin>, MintCapability<AptosCoin>) {
