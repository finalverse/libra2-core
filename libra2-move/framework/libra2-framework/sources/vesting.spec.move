spec libra2_framework::vesting {
    ...
    /// period.
    /// Enforcement: Audited the check for the end of vesting cliff: [https://github.com/aptos-labs/aptos-core/blob/main/aptos-move/framework/libra2-framework/sources/vesting.move#L566](vest) module.
    ///
    /// No.: 5
    ...
    spec schema DistributeInternalAbortsIf {
        ...
        aborts_if !exists<stake::ValidatorSet>(@libra2_framework);
        let validator_set = global<stake::ValidatorSet>(@libra2_framework);
