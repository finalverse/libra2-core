module libra2_framework::permissioned_delegation {
    use std::error;
    ...
    use libra2_framework::rate_limiter;
    use libra2_framework::rate_limiter::RateLimiter;
    #[test_only]
    use std::bcs;
    #[test_only]
    use std::option;
    ...
    #[test_only]
    use libra2_framework::account::create_signer_for_test;
    #[test_only]
    ...
    fun test_basics(account: signer, account_copy: signer) acquires RegisteredDelegations {
        let libra2_framework = create_signer_for_test(@libra2_framework);
