...
module libra2_framework::fungible_asset {
    ...
    use libra2_framework::object::{Self, Object, ConstructorRef, DeleteRef, ExtendRef};
    ...
    #[test(fx = @libra2_framework, creator = @0xcafe)]
    ...
    fun test_e2e_withdraw_limit(
        ...
        let libra2_framework = account::create_signer_for_test(@0x1);
