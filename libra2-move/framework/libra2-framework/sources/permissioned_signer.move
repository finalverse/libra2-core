...
/// for blind signing.
module libra2_framework::permissioned_signer {
    use std::features;
    use std::signer;
    use std::error;
    use std::vector;
    ...
    use libra2_framework::big_ordered_map::{Self, BigOrderedMap};
    use libra2_framework::create_signer::create_signer;
    use libra2_framework::transaction_context::generate_auid_address;
    ...
    fun signer_address_roundtrip(
        ...
        let libra2_framework = create_signer(@0x1);
