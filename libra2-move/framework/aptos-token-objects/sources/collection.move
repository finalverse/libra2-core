...
module aptos_token_objects::collection {
    ...
    use libra2_framework::aggregator_v2::{Self, Aggregator, AggregatorSnapshot};
    ...
    #[expected_failure(abort_code = 0x50003, location = libra2_framework::object)]
    ...
    entry fun test_create_and_transfer_as_owner(creator: &signer, trader: &signer, libra2_framework: &signer) {
