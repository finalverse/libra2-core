...
module libra2_token::token_transfers {
    use std::signer;
    ...
    public fun test_nft(creator: signer, owner: signer) acquires PendingClaims {
        ...
        libra2_framework::account::create_account_for_test(owner_addr);
    ...
    public fun test_editions(
        ...
        libra2_framework::account::create_account_for_test(owner0_addr);
        let owner1_addr = signer::address_of(&owner1);
        libra2_framework::account::create_account_for_test(owner1_addr);
    ...
    public fun create_token(creator: &signer, amount: u64): TokenId {
        ...
        libra2_framework::account::create_account_for_test(signer::address_of(creator));
