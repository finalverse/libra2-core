...
Returns the current chain ID, mirroring what <code>libra2_framework::chain_id::get()</code> would return, except in <code>#[test]</code>
functions, where this will always return <code>4u8</code> as the chain ID, whereas <code>libra2_framework::chain_id::get()</code> will
return whichever ID was passed to <code>libra2_framework::chain_id::initialize_for_test()</code>.
...
<pre><code><b>public</b> <b>fun</b> <a href="type_info.md#0x1_type_info_chain_id">chain_id</a>(): u8 {
    <b>if</b> (!<a href="../../../move-stdlib/tests/compiler-v2-doc/features.md#0x1_features_libra2_stdlib_chain_id_enabled">features::libra2_stdlib_chain_id_enabled</a>()) {
...
Example: 0x1::coin::CoinStore<0x1::libra2_coin::Libra2Coin>
...
<pre><code><b>aborts_if</b> !<a href="../../../move-stdlib/tests/compiler-v2-doc/features.md#0x1_features_spec_is_enabled">features::spec_is_enabled</a>(<a href="../../../move-stdlib/tests/compiler-v2-doc/features.md#0x1_features_LIBRA2_STD_CHAIN_ID_NATIVES">features::LIBRA2_STD_CHAIN_ID_NATIVES</a>);
