...
<pre><code><b>public</b> inline <b>fun</b> <a href="any.md#0x1_any">any</a>&lt;K, V&gt;(
    ...
    <b>let</b> i = 0;
    <b>while</b> (i &lt; libra2_std::smart_table::num_buckets(self)) {
        found = <a href="../../move-stdlib/doc/vector.md#0x1_vector_any">vector::any</a>(<a href="table_with_length.md#0x1_table_with_length_borrow">table_with_length::borrow</a>(libra2_std::smart_table::borrow_buckets(self), i), |elem| {
            <b>let</b> (key, value) = libra2_std::smart_table::borrow_kv(elem);
            p(key, value)
        });
