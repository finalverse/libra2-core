...
module libra2_std::bls12381 {
    ...
    /// Random signature generated by running `cargo test -- bls12381_sample_signature --nocapture --include-ignored` in `crates/libra2-crypto`.
    ...
    fun test_pubkey_aggregation() {
        // Second, try some test-cases generated by running the following command in `crates/libra2-crypto`:
    ...
    fun test_verify_pop() {
        // Test case generated by running `cargo test -- sample_pop --nocapture --include-ignored` in `crates/libra2-crypto`
        // =============================================================================================================
