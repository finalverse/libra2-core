...
use libra2_crypto::ed25519::{Ed25519PrivateKey, Ed25519PublicKey, Ed25519Signature};
...
impl CryptoStorage for Box<Storage> {
    ...
    fn sign<T: libra2_crypto::hash::CryptoHash + Serialize>(
        &self,
        name: &str,
        message: &T,
    ...
    fn sign_using_version<T: libra2_crypto::hash::CryptoHash + Serialize>(
        &self,
        name: &str,
        version: Ed25519PublicKey,
        message: &T,
