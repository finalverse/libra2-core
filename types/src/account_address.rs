...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"libra2_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"libra2_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"libra2_framework::vesting";
...
// See this issue for potential improvements: https://github.com/finalverse/libra2-core/issues/3960
