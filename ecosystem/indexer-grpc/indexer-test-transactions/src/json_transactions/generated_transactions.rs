...
pub const IMPORTED_MAINNET_TXNS_84023785_TOKEN_V2_CLAIM_OFFER: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/84023785_token_v2_claim_offer.json"
));
