...
/// Encoded file descriptor set for the `libra2.remote_executor.v1` package
...
include!("libra2.remote_executor.v1.serde.rs");
include!("libra2.remote_executor.v1.tonic.rs");
