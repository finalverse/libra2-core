...
export const RawDataService = {
  ...
  getTransactions: {
    path: "/libra2.indexer.v1.RawData/GetTransactions",
    requestStream: false,
    responseStream: true,
...
export const RawDataClient = makeGenericClientConstructor(RawDataService, "libra2.indexer.v1.RawData") as unknown as {
