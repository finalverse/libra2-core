...
pub(crate) static LIBRA2_TELEMETRY_SERVICE_SUCCESS: Lazy<IntCounterVec> = Lazy::new(|| {
...
pub(crate) static LIBRA2_TELEMETRY_SERVICE_FAILURE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
...
pub(crate) static LIBRA2_TELEMETRY_SUCCESS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "libra2_telemetry_success",
...
/// TODO: Clean up when cleaning up telemetry exporter to GA
pub(crate) static LIBRA2_TELEMETRY_FAILURE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "libra2_telemetry_failure",
