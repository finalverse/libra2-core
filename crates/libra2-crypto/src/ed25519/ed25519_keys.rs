...
impl Ed25519PrivateKey {
    ...
    /// TODO: We are temporarily breaking the abstraction here and exposing the SK scalar. In the future, we should add traits for encryption inside libra2-crypto so that we can both sign and decrypt with an Ed25519PrivateKey.
