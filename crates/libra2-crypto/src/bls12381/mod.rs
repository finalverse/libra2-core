...
//! ```
//! use std::iter::zip;
//! use libra2_crypto::test_utils::{KeyPair, TestLibra2Crypto};
//! use libra2_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use libra2_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use libra2_crypto::bls12381::ProofOfPossession;
//! use libra2_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/libra2-crypto/src/test_utils.rs`:
//! //
...
//! use libra2_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use libra2_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use libra2_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use libra2_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use libra2_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/libra2-crypto/`
...
//! // signature on TestLibra2Crypto("test".to_owned())
