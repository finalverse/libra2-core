...
//!
//! ```
//! use libra2_crypto::{x25519, Uniform, test_utils::TEST_SEED};
...
//! use libra2_crypto::traits::ValidCryptoMaterialStringExt;
//! # fn main() -> Result<(), libra2_crypto::traits::CryptoMaterialError> {
