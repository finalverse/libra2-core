...
const ERROR_MESSAGE: &str = "Docker is not available, confirm it is installed and running. See https://dev.libra2.org/guides/local-development-network#faq for assistance.";
