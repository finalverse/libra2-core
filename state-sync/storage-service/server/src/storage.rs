...
use libra2_storage_interface::{AptosDbError, DbReader, Result as StorageResult};
use libra2_storage_service_types::responses::{
...
pub trait StorageReaderInterface: Clone + Send + 'static {
    ...
    fn get_transactions_with_proof(
        ...
        end_version: u64,
        include_events: bool,
    ) -> libra2_storage_service_types::Result<TransactionListWithProof, Error>;
    ...
    fn get_transaction_outputs_with_proof(
        ...
        start_version: u64,
        end_version: u64,
    ) -> libra2_storage_service_types::Result<TransactionOutputListWithProof, Error>;
    ...
    ) -> libra2_storage_service_types::Result<TransactionOrOutputListWithProof, Error>;
