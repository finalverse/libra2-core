...
def main(gas_per_ns):
    path = Path('aptos-move/aptos-gas-schedule/src/gas_schedule/libra2_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs batch verification in `aptos-move/aptos-gas-schedule/src/gas_schedule/libra2_framework.rs`.')
