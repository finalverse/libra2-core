...
## Quickstart guide
Ensure you are on a machine with the [required spec](https://dev.libra2.org/nodes/validator-node/operator/node-requirements/).
...
Combined with the [pre-defined](https://github.com/finalverse/libra2-core/blob/2d6ed231ca39fc07422dfe95aa76746b2210e36d/libra2-move/libra2-gas-schedule/src/gas_schedule/move_stdlib.rs#L23-L24) SHA2-256 gas formula (unscaled internal gas):`g(n)=183n+11028`,
