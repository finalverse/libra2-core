...
use libra2_db_indexer_schemas::schema::event_sequence_number::EventSequenceNumberSchema;
use libra2_schemadb::DB;
use libra2_storage_interface::{
    state_store::state_view::db_state_view::LatestDbStateCheckpointView, Libra2DbError, DbReader,
    Result,
};
use libra2_types::{
    account_config::{
...
impl EventV2Translator for TokenMutationTranslator {
    fn translate_event_v2_to_v1(
        ...
        let (key, sequence_number) = if let Some(state_value_bytes) = engine
            ...
            return Err(Libra2DbError::from(anyhow::format_err!(
