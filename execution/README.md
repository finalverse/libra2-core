...
id: executor
title: Executor
custom_edit_url: https://github.com/finalverse/libra2-core/edit/main/executor/README.md
---


## Overview

The Libra2 Blockchain is a replicated state machine. Each validator is a replica
...
in the Libra2 Node config file for it to work, but can leave other entries
default by not specifying them.

```yaml
execution:
    # see https://github.com/finalverse/libra2-core/blob/main/config/src/config/test_data/public_full_node.yaml
    # for explanation
