...
## Unreleased
- OpenAPI layout changed slightly in some enum cases, see [#13929](https://github.com/finalverse/libra2-core/pull/13929) for more information.
...
## 1.1.0 (2022-09-08)
- A new endpoint has been added for getting events: `/accounts/{address}/events/{creation_number}`. If you would make a request to `/events/{event_key}` like in `Example A` below, you would use the new endpoint like in `Example B`. See [#4012](https://github.com/finalverse/libra2-core/pull/4012) for more information on this change.
...
- We return BCS data with the `application/x-bcs` content type. The input uses the existing mime types. We should unify them though: https://github.com/finalverse/libra2-core/issues/2275.
...
### Noteworthy PRs
- The main original PR. Here you can see a breakdown of why we chose Poem over the alternatives (of which there were few): https://github.com/finalverse/libra2-core/pull/1906.
- This PR focuses on response and error handling: https://github.com/finalverse/libra2-core/pull/2139
- This PR adds the remaining endpoints and splits up the testing infrastructure: https://github.com/finalverse/libra2-core/pull/2156
- This PR adds a standalone binary for spec generation: https://github.com/finalverse/libra2-core/pull/2317

## Deprecation notes
- Currently Libra2 nodes host both the v0 and v1 APIs. We will remove the v0 API by 2022-09-01. If you're a dapp developer, you should only need to update to a newer version of the SDK you use. If you're an SDK / client developer, please update your SDK / client. Reach out to the Libra2 team via [Discord](https://discord.gg/XXUf99QJ) for assistance with this, we will be happy to help.
