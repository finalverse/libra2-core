...
pub const BCS_VIEW_FUNCTION: &str = "application/x.libra2.view_function+bcs";

pub const BCS_SIGNED_TRANSACTION: &str = "application/x.libra2.signed_transaction+bcs";
